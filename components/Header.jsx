import logoimg from '../assets/images/logo-grey.png'
			 	...
			 	<div className="headtoppart bg-blue clearfix">
			  	...
			  	<div className="wsmainfull menu clearfix">
    				<div className="wsmainwp clearfix">
    					...
    					<div className="desktoplogo"><a href="#hero-1"><img src={logoimg} width="180" height="40" alt="header-logo"/></a></div>
             							...
             							<div className="container">
               								<div className="row">
								                ...
								                <div className="col-lg-5 col-md-12 col-xs-12">
								                    ...
								                    <div className="fluid-width-video-wrapper"><img src={logoimg} alt="featured-news" /></div>
								                ...
								                <div className="col-lg-4 col-md-12 col-xs-12">
                    								...
                    								<ul className="latest-news">
														...
														<li className="clearfix d-flex align-items-center">
															...
															<img className="img-fluid" src={logoimg} alt="blog-post-preview" />
